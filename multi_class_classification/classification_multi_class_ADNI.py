...
data_folder_MCI = r'C:\....\ADNI\After_matching\{}_PCA_tangent_data'.format(condi_MCI) 
...
data_folder_interp_MCI = r'C:\....\ADNI\After_matching\{}_interpolated_PCA_tangent_data'.format(condi_MCI) 
...
all_data = CN_data + AD_data + MCI_data  # format is like this [[tensors of time_data], label], .... ]
