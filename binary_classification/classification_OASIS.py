...
data_folder_AD = r'C:\....\OASIS\After_matching\{}_PCA_tangent_data'.format(condi_AD) 
data_folder_CN = r'C:\....\OASIS\After_matching\{}_PCA_tangent_data'.format(condi_CN) 

data_folder_interp_AD = r'C:\....\OASIS\After_matching\{}_interpolated_PCA_tangent_data'.format(condi_AD) 
data_folder_interp_CN = r'C:\....\OASIS\After_matching\{}_interpolated_PCA_tangent_data'.format(condi_CN) 
